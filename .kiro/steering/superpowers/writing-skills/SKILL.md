...
```yaml
# 鉂?BAD: Summarizes workflow - Claude may follow this instead of reading skill
...
- 鉁?Good: `**REQUIRED SUB-SKILL:** Use superpowers:test-driven-development`
- 鉁?Good: `**REQUIRED BACKGROUND:** You MUST understand superpowers:systematic-debugging`
- 鉂?Bad: `See skills/testing/test-driven-development` (unclear if required)
- 鉂?Bad: `@skills/testing/test-driven-development/SKILL.md` (force-loads, burns context)
